...
def test_probe_should_log_warning_given_missing_ods_code():
    ...
    mock_logger.warning.assert_called_once_with("ASIDS not found for ODS code: ABC123")
...
def test_probe_should_log_warning_given_duplicate_organisation():
    ...
    mock_logger.warning.assert_called_once_with("Duplicate ODS code found: X45")
